...
function Footer() {
    return ( 
        <footer style={{ backgroundColor: "rgb(251, 251, 251)" }} className='border-top '>
        <div className='footer container mt-5 '>
            <div className='row'>
                <div className='col text-muted' style={{ fontSize: "14px" }}>
                     <img src="media/images/logo.svg" style={{ width: "65%" }} /> <br/> <br/>
                     <p> &copy; 2010 - 2024, Zerodha Broking Ltd. <br/>All rights reserved.
                    </p>
                </div>
                <div className='col' >
                ...
                <div className='mt-5' style={{ fontSize: "11px" ,color:"rgb(155,155,155)"}}>
