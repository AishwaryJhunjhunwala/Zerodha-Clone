  ...
  return (
    <div className="container">
      <div className="row mb-5 text-center">
        <h5>Calculate your costs upfront using our brokerage calculator</h5>
        <div className="text-start ms-4 ">
                <h5>Charges Explained</h5>
            </div>
        <div className="col-6 text-muted p-5 text-start" >
        ...
        <div className="col-6 text-muted text-start p-5">
            <h6>
                GST
            </h6>
...
SEBI Charges
            ...
            <h6>DP (Depository participant) charges
