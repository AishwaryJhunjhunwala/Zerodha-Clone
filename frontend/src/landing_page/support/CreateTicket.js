        ...
        <div className="container">
            <div className="row mt-5 mb-5">
                ...
                <div className="col-md-4 mt-4 mb-2">
                    <h4 className="" style={{fontSize:"18px"}}><i class="fa fa-plus-circle" aria-hidden="true"></i> Account Opening</h4>
                ...
                <div className="col-md-4 mt-4 mb-2">
                    <h4 className="" style={{fontSize:"18px"}}><i class="fa-regular fa-user"></i> Your Zerodha Account</h4>
                    ...
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Client Master Report (CMR) and Depository</a><br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>Participant (DP)</a><br />
                ...
                <div className="col-md-4 mt-4 mb-2">
                    <h4 className="" style={{fontSize:"18px"}}><i class="fa fa-plus-circle" aria-hidden="true"></i> Kite</h4>
                ...
                <div className="col-md-4 mt-4 mb-2">
                    <h4 className="" style={{fontSize:"18px"}}><i class="fa-solid fa-wallet"></i> Funds</h4>
                ...
                <div className="col-md-4 mt-4 mb-2">
                    <h4 className="" style={{fontSize:"18px"}}><i class="fa-solid fa-user-tie"></i>  Console</h4>
                ...
                <div className="col-md-4 mt-4 mb-2">
                    <h4 className="" style={{fontSize:"18px"}}><i class="fa-solid fa-coins"></i>  Coin</h4>
